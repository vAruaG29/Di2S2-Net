...
csv_logs/metrics.csv. Dependency: matplotlib only. Saves PNGs into
final_submission_and_inference/presentation_figures/."""
import csv, os
import matplotlib
matplotlib.use("Agg")
import matplotlib.pyplot as plt

ROOT = "/Users/gauravshende/hackathon"
OUT = os.path.join(ROOT, "final_submission_and_inference", "presentation_figures")
...
def comparison():
    ...
    runs = [
        ("final_submission_and_inference/logs_2val/run_20260605_091158/csv_logs/version_0/metrics.csv",
...
curve(os.path.join(ROOT, "final_submission_and_inference/logs_2val/run_20260605_091158/csv_logs/version_0/metrics.csv"),
